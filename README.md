...
Run the Composer require command from the Terminal:
    ...
    composer require k3ntu/shoppingcart
    
If you're using Laravel 5.7, this is all there is to do. 

Should you still be on version 5.6 of Laravel, the final steps for you are to add the service provider of the package and alias the package. To do this open your `config/app.php` file.
